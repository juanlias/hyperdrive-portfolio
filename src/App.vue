    ...
    <transition name="fade">
      ...
      >
        ...
        <div class="relative w-24 h-24">
          <div class="guide-circle absolute inset-0 rounded-full border-2 border-current opacity-60"></div>
          <div class="guide-circle-moving absolute inset-0 rounded-full border-2 border-current"></div>
          <div class="guide-dot absolute top-1/2 left-1/2 w-2 h-2 bg-current rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>
        </div>
      </div>
    </transition>
...
<!--
  Hyperdrive Portfolio - Main App Component
  
  A stunning portfolio website with hyperspace travel animation
